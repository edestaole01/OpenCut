...
const demoAccounts = [
  { label: "Entrar como Admin", email: "admin@videoai.com", password: "admin123456", icon: Shield, variant: "default" as const },
  { label: "Entrar como Usuário", email: "user@videoai.com", password: "user123456", icon: User, variant: "outline" as const },
];
      ...
      <form onSubmit={handleLogin}>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-xs text-muted-foreground font-medium uppercase">Acesso rápido para teste</p>
            <div className="grid grid-cols-2 gap-2">
              {demoAccounts.map((account) => (
                ...
                >
                  ...
                  {loadingDemo === account.label ? "Entrando..." : account.label}
                </Button>
              ))}
            </div>
          </div>
