		...
		<div className="space-y-8">
			<div className="flex items-center gap-3">
				...
				<div>
					...
					<p className="text-muted-foreground">
						Gerencie suas IAs e preferências
					</p>
				</div>
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Adicione suas chaves para cada provedor de IA
					</CardDescription>
				</CardHeader>
						...
						>
							<div className="flex-1">
								<div className="flex items-center gap-2 mb-1">
									<p className={`font-medium text-sm ${provider.color}`}>
										{provider.name}
									</p>
									{keys[provider.id] && (
										<Badge
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Escolha qual modelo usar para cada função
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					{features.map((feature) => (
						<div key={feature.id} className="flex items-center justify-between">
							...
							<Select
								...
								onValueChange={(value) =>
									setFeatureModels({ ...featureModels, [feature.id]: value })
								}
							>
