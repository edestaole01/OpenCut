...
const STEPS = [
	{
		...
		description:
			"Este editor tem 4 áreas principais. Vamos conhecê-las rapidamente.",
		content: (
			<div className="grid grid-cols-2 gap-2 mt-3">
				{[
					{
						area: "① Esquerda",
						desc: "Abas de mídia, texto, efeitos e configurações",
						color: "bg-blue-500/10 border-blue-500/30 text-blue-600",
					},
					{
						area: "② Centro",
						desc: "Prévia do vídeo — veja o resultado em tempo real",
						color: "bg-green-500/10 border-green-500/30 text-green-600",
					},
					{
						area: "③ Direita",
						desc: "Propriedades do elemento selecionado (posição, cor...)",
						color: "bg-orange-500/10 border-orange-500/30 text-orange-600",
					},
					{
						area: "④ Baixo",
						desc: "Timeline — organize e edite seus clips aqui",
	...
	},
	{
		...
		description:
			'Clique na aba "Mídia" (ícone de pasta) no painel esquerdo, depois clique em Importar ou arraste seus arquivos.',
		content: (
			<div className="mt-3 rounded-lg bg-muted/50 p-3 space-y-2">
				...
				<div className="flex flex-wrap gap-1.5">
					{["MP4", "MOV", "AVI", "MKV", "PNG", "JPG", "MP3", "WAV"].map((f) => (
						<span
							key={f}
							className="text-[10px] bg-background border rounded px-1.5 py-0.5 font-mono"
						>
							{f}
						</span>
					))}
				...
				<p className="text-xs text-muted-foreground mt-2">
					💡 Após importar, <strong>arraste o arquivo</strong> para a timeline
	...
	},
	{
		...
		description:
			"A timeline é onde você organiza e corta os clips. Use as ferramentas no topo da timeline:",
		content: (
			<div className="mt-3 space-y-2">
				{[
					...
					<div key={item.key} className="flex items-center gap-2.5">
						<kbd className="bg-muted border rounded px-2 py-0.5 text-[10px] font-mono shrink-0 min-w-[40px] text-center">
							{item.key}
						</kbd>
	...
	},
	{
		...
		description:
			"Quando terminar, clique no botão azul Export no canto superior direito.",
		content: (
			<div className="mt-3 space-y-3">
				<div className="rounded-lg bg-muted/50 p-3 space-y-1.5">
					...
					{[
						...
						{
							label: "Resolução",
							value: "Definida nas configurações do projeto",
						},
					].map((item) => (
