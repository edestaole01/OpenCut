...
import { timelineTimeToPixels, getCumulativeHeightBefore, } from "@/lib/timeline";
import { Button } from "@/components/ui/button";
import { ScissorIcon, Delete02Icon, Copy01Icon, } from "@hugeicons/core-free-icons";
...
export function SelectionOverlay({ 
	...
	useEffect(() => {
		...
		const element = track?.elements.find(e => e.id === lastSelection.elementId);
		...
		const y = getCumulativeHeightBefore({ tracks, trackIndex }) + TIMELINE_CONSTANTS.PADDING_TOP_PX;
